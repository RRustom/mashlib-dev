  ...
  render: function render(subject, context) {
    ...
    */
    ...
    var renderPeriod = function renderPeriod() {
      ...
      var inPeriod = function inPeriod(date) {
      ...
      var transactionInPeriod = function transactionInPeriod(x) {
      ...
      */
      ...
      var transactionTable = function transactionTable(dom, list) {
      ...
      for (var y in xURIs) {
        ...
        if (xURIs.hasOwnProperty(y)) {
          z = kb.sym(y);
          var tt = kb.each(z, ns.rdf('type')); // What EXPLICIT definitions
      ...
      var catSymbol = function catSymbol(catTail) {
      ...
      var checkCatHasField = function checkCatHasField(catTail, pred) {
